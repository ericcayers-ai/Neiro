...
from neiro.engine.artifacts import AudioTensor, AnalysisReport
...
def analyze(audio: AudioTensor) -> AnalysisReport:
    ...
    if bandwidth < 16000 and sr >= 44100:
        notes.append(
            ...
            "restoration (Apollo) may improve separation"
        )
    ...
    return AnalysisReport(
        ...
        vocal_conditions={"stereo_correlation": round(corr, 4)},
        notes=tuple(notes),
    )
